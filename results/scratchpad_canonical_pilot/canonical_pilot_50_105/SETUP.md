...
```bash
python scripts/scratchpad_frontier_eval.py --mode run --scenario-dir results/scratchpad_canonical_pilot/canonical_pilot_50_105 --agent heuristic --prompt-profile meaning
python scripts/scratchpad_frontier_eval.py --mode run --scenario-dir results/scratchpad_canonical_pilot/canonical_pilot_50_105 --agent openai --model gpt-5.2 --openai-reasoning-mode auto --prompt-profile meaning
python scripts/scratchpad_frontier_eval.py --mode run --scenario-dir results/scratchpad_canonical_pilot/canonical_pilot_50_105 --agent openai --model gpt-5.2 --openai-reasoning-mode high --prompt-profile meaning
```
